...

{
	...
	strcpy_s(this->gSensorNames[1], sizeof(this->gSensorNames[1]), "aps"); // hard disk protection gyroscope
	...
	// power supply (gets hot while charging battery)
	...
	// taskbar icon (keep code after reading config)

	if (this->MinimizeToSysTray)
	{
		// that's where the ICON dog lies buried
